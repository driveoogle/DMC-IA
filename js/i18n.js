...
const translations = {
  en: {
    ...
    form_m4t:"Automation with AI",
    form_m4p:"Introduction to automation tools (n8n, Make, Zapier) integrated with AI models. Building simple workflows.",
    ...
    form_fmt2t:"Small Groups",
    form_fmt2p:"Maximum 12 participants per session to ensure personalised coaching and hands-on practice.",
    ...
    form_fmt4t:"Post-Training Support",
    form_fmt4p:"30 days of email support and access to updated reference materials after each session.",
    ...
    form_faq2q:"How many people can participate per session?",
    form_faq2a:"We recommend groups of 6 to 12 people to ensure quality. For larger groups, we organise multiple sessions.",
    form_faq3q:"Can the training be delivered in English?",
    form_faq3a:"Yes. Sessions can be conducted in Portuguese or English, depending on the team's needs.",
    form_faq4q:"Do you have training for executive teams (C-suite)?",
  ...
  pt: {
    ...
    form_m4t:"Automatização com IA",
    form_m4p:"Introdução às ferramentas de automação (n8n, Make, Zapier) integradas com modelos de IA. Construção de fluxos simples.",
    ...
    form_fmt2t:"Turmas Reduzidas",
    form_fmt2p:"Máximo 12 participantes por sessão para garantir acompanhamento personalizado e prática efetiva.",
    ...
    form_fmt4t:"Acompanhamento Pós-Formação",
    form_fmt4p:"30 dias de acesso a suporte por email e materiais de referência atualizados após cada sessão.",
    ...
    form_faq2q:"Quantas pessoas podem participar por sessão?",
    form_faq2a:"Recomendamos turmas de 6 a 12 pessoas para garantir qualidade. Para grupos maiores, organizamos múltiplas sessões.",
    form_faq3q:"A formação pode ser dada em inglês?",
    form_faq3a:"Sim. As sessões podem ser realizadas em português ou inglês, conforme a necessidade da equipa.",
    form_faq4q:"Têm formação para equipas executivas (C-suite)?",
