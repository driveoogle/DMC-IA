...
const translations = {
  en: {
    ...
    form_sub:"Hands-on training in generative AI and prompt engineering — designed for professionals who want to use AI with confidence in their daily work.",
    ...
    form_m6p:"You develop a real use case for your own role. Personalised feedback throughout every session.",
    ...
    form_fmt3p:"The programme is adapted to your sector, the tools you already use, and the most relevant use cases for you.",
    ...
    form_why3p:"We set objectives before the training and measure results with you after implementation.",
    form_cta_label:"Start today",
    form_cta_h2:"Ready to level up?",
    form_cta_sub:"Tell us about your needs and we'll put together a programme tailored to you.",
  ...
  pt: {
    ...
    form_h1b:"Transforme a sua prática.",
    form_sub:"Formação prática em IA generativa e prompt engineering — desenhada para profissionais que querem usar a IA com confiança no dia a dia.",
    ...
    form_m6p:"Desenvolve um caso de uso real para a sua função. Feedback personalizado ao longo de cada sessão.",
    ...
    form_fmt3p:"O programa é adaptado ao seu setor, às ferramentas que já usa e aos casos de uso mais relevantes para si.",
    ...
    form_why3p:"Definimos objetivos antes da formação e medimos os resultados consigo após a implementação.",
    form_cta_label:"Comece hoje",
    form_cta_h2:"Pronto para evoluir?",
    form_cta_sub:"Fale connosco sobre as suas necessidades e elaboramos um programa à sua medida.",
    form_cta_btn:"Solicitar programa",
    form_faq_label:"FAQ",
    form_faq_h2:"Perguntas frequentes.",
    form_faq1q:"Preciso de ter conhecimentos técnicos de IA?",
    form_faq1a:"Não. A formação é desenhada para profissionais sem background técnico. Começamos pelos fundamentos e avançamos ao seu ritmo.",
    /* HOME TRAINING HIGHLIGHT */
